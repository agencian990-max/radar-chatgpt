...
async function init() {
  ...
  `);
  // Proveedor de IA específico de este término ('openai' | 'openrouter'). NULL = usa el default global (AI_PROVIDER).
  await pool.query(`
    ALTER TABLE keywords ADD COLUMN IF NOT EXISTS ai_provider TEXT;
  `);
