...
async function init() {
  ...
  `);
  // Pausa de rastreo: si es true, el proyecto NO se revisa -- ni por el cron automático
  // ni por el botón "Revisar ahora" ni por el botón manual de un término individual --
  // hasta que se reanude (is_paused = false).
  await pool.query(`
